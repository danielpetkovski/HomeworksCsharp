...
namespace SEDC.Task2
{
    class Program
    {
        ...
        public static void RaceCars(Car car1, Car car2)
        {
            ...
            {
                Console.WriteLine($"Car no.1 was faster, with speed: {car1.CalculateSpeed()} and driver {car1.Driver.Name}");
            }
            else if (car1.CalculateSpeed() < car2.CalculateSpeed())
            {
                Console.WriteLine($"Car no.2 was faster,with speed: {car2.CalculateSpeed()} and driver {car2.Driver.Name}");
            }
            else
            {
